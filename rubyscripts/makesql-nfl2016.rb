...
def processPlay (gameSeason)
	...
	# 
	if File.exist?('nfl2016-insert-play.sql')
		File.delete('nfl2016-insert-play.sql')
	end

	File.write('nfl2016-insert-play.sql', sqlStr)
end
...
def processBye(gameSeason)
	...
	# write string to file
	# 
	if File.exist?('nfl2016-insert-bye.sql')
		File.delete('nfl2016-insert-bye.sql')
	end

	File.write('nfl2016-insert-bye.sql', sqlStr)
end
