// define factories
dddAppMobile.factory('nflteamsFactory', function($q, $http) {
    var factory = {};
...
dddAppMobile.factory('membersFactory', function($q, $http) {
    var factory = {};
...
dddAppMobile.factory('keyrequestsFactory', function($q, $http) {
    var factory = {};
...
dddAppMobile.factory('temploginFactory', function($q, $http) {
    var factory = {};
...
dddAppMobile.factory('loginFactory', function($q, $http) {
    var factory = {};
...
dddAppMobile.factory('scriptsFactory', function($q, $http) {
    var factory = {};
