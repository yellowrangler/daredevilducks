...
//
$startgameid = "";
if (isset($_POST["startgameid"]))
{
	// $dontShowSql = 1;   Uncomment for production
	$startgameid = $_POST["startgameid"];
}
else
{
	if (isset($_GET["startgameid"]))
	{
		$startgameid = $_GET["startgameid"];
	}
	else
	{
		$msgtext = "Invalid parm startgameid";
		exit($msgtext);
	}
}
//---------------------------------------------------------------
...
// fix is only to be applied to games from startgameid
$gamecount = $startgameid;
